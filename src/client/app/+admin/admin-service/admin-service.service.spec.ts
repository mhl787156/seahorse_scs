...
import { CustomerServiceService } from './admin-service.service';
...
export function main() {
  describe('NameList Service', () => {
    ...
    beforeEach(() => {
      ...
      CustomerServiceService = injector.get(CustomerServiceService);
      backend = injector.get(MockBackend);

      let connection: any;
      backend.connections.subscribe((c: any) => connection = c);
      initialResponse = CustomerServiceService.get();
